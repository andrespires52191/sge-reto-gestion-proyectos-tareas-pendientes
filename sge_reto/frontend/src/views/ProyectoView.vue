...
<template>
  <div>
    ...
    <div v-if="proyectoStore.cargando" class="alert alert-info">Cargando...</div>
    ...
    <div v-else>
      ...
      <div v-if="proyectos.length === 0 && !mostrandoCrear" class="alert alert-info">No hay proyectos en la base de
        datos.
      </div>
